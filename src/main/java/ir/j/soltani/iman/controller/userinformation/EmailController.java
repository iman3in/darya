...
package ir.j.soltani.iman.controller.userinformation;

import ir.j.soltani.iman.common.Singletons;
import ir.j.soltani.iman.controller.userinformation.dto.EmailDto;
...
import ir.j.soltani.iman.service.userinformation.EmailService;
...
public class EmailController {
    ...
    @Autowired
    public EmailController(EmailService emailService, EmailTypeService emailTypeService) {
    ...
    public ResponseEntity<EmailDto> createEmail (@RequestBody EmailDto inputDto){
        /**
         * @Todo
         * Set EmailType Nullable Or Make a service for default EmailType Value.
         * Move This Code To Service Layer
         */
        EmailType emailType = emailTypeService.readById(inputDto.getEmailTypeId());
        Email email = modelMapper.map(inputDto, Email.class);
        email.setEmailType(emailType);
        email = emailService.createUserEmail(email, inputDto.getUserId());
